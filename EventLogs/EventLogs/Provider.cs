...
using WisLogs.Contracts;
using WisLogs.Contracts.Interfaces;
using WisLogs.Utility.Exception;
using log4net;
using log4net.Config;

namespace WisLogs.Logs
{
    /// <summary>
    /// Logger Provider
    /// </summary>
    public class LogProvider : IProvider
    {
        #region Fields
        ...
        /// Logger instance
        /// </summary>
        private static volatile LogProvider _instance;

        /// <summary>
        /// Get logger
        /// </summary>
        private static ILog _logger = LogManager.GetLogger(typeof(LogProvider));
        ...
        /// </summary>
        public static LogProvider Instance => _instance ?? (_instance = new LogProvider());
